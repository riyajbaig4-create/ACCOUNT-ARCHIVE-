...
class FollowerBot:
    def __init__(self, tokens_file=None, telegram_mode=False, chat_id=None, bot_instance=None, loop=None, user_id=None, bot_data=None):
        ...
        self.target_id = None        self.initial_followers = 0
...
2. PLACE ORDER
   ...
   {{"api_key": "{api_key}", "product_id": 1, "target_id": "14423134156", "user_id": "7018768597"}}
...
if TELEGRAM_AVAILABLE:
    ...
    async def handle_api_guide(update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        # 🔥 MAIN BOT URL - Render pe deploy kiye gaye bot ka URL
        # 🔥 YE CHANGE KARO - Apna Render URL daalo
...
def api_products():
    try:
        ...
        return jsonify({"status": "success", "role": "Reseller", "balance": balance, "products": products})
    except Exception as e:
...
def api_follow():
    try:
        ...
        followers_needed = product_costs.get(product_id, 2)  # 2 = 20 followers
